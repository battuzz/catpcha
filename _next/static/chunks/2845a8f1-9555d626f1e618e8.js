"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[426],{9853:function(e,t,r){r.d(t,{ET:function(){return i9},PL:function(){return i3},ad:function(){return iR},hJ:function(){return ik}});var n,i,s,a,o=r(4569),l=r(1865),u=r(4400),h=r(6720),c=r(1339),d=r(1885);r(4492);var f=r(7135).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iM{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new S(C.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new $(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iF{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new S(C.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new S(C.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return O(this._lat,e._lat)||O(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iP{constructor(e){this._values=(e||[]).map(e=>e)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(e,t){if(e.length!==t.length)return!1;for(let r=0;r<e.length;++r)if(e[r]!==t[r])return!1;return!0}(this._values,e._values)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let iU=/^__.*__$/;class iq{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return null!==this.fieldMask?new tM(e,this.data,this.fieldMask,t,this.fieldTransforms):new tV(e,this.data,t,this.fieldTransforms)}}function iB(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw I()}}class iz{constructor(e,t,r,n,i,s){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=n,void 0===i&&this.yu(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get wu(){return this.settings.wu}Su(e){return new iz(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}bu(e){var t;let r=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.Su({path:r,Du:!1});return n.vu(e),n}Cu(e){var t;let r=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.Su({path:r,Du:!1});return n.yu(),n}Fu(e){return this.Su({path:void 0,Du:!0})}Mu(e){return iW(e,this.settings.methodName,this.settings.xu||!1,this.path,this.settings.Ou)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}yu(){if(this.path)for(let e=0;e<this.path.length;e++)this.vu(this.path.get(e))}vu(e){if(0===e.length)throw this.Mu("Document fields must not be empty");if(iB(this.wu)&&iU.test(e))throw this.Mu('Document fields cannot begin and end with "__"')}}class i${constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||r4(e)}Nu(e,t,r,n=!1){return new iz({wu:e,methodName:t,Ou:r,path:$.emptyPath(),Du:!1,xu:n},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function iK(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof P||e instanceof iF||e instanceof iV||e instanceof iN||e instanceof iO||e instanceof iP)}function iQ(e,t,r){if(!iK(r)||!("object"==typeof r&&null!==r&&(Object.getPrototypeOf(r)===Object.prototype||null===Object.getPrototypeOf(r)))){let n=iE(r);throw"an object"===n?t.Mu(e+" a custom object"):t.Mu(e+" "+n)}}let iG=RegExp("[~\\*/\\[\\]]");function ij(e,t,r){if(t.search(iG)>=0)throw iW(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,r);try{return new iM(...t.split("."))._internalPath}catch(n){throw iW(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,r)}}function iW(e,t,r,n,i){let s=n&&!n.isEmpty(),a=void 0!==i,o=`Function ${t}() called with invalid data`;r&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${n}`),a&&(l+=` in document ${i}`),l+=")"),new S(C.INVALID_ARGUMENT,o+e+l)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,r={}){let n=new N;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new nq(r,new il({next:r=>{t.enqueueAndForget(()=>nO(e,s)),r.fromCache&&"server"===n.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(r)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,_a:!0});return nM(e,s)})(await ig(e),e.asyncQueue,t,r,n)),n.promise})(r,e._query).then(r=>new i2(t,n,e,r)))}function i9(e,t){var r,n;let i=iT(e.firestore,iD),s=function(e,t,...r){if(e=(0,h.m9)(e),1==arguments.length&&(t=M.newId()),iv("doc","path",t),e instanceof iC){let n=B.fromString(t,...r);return iw(n),new iN(e,null,new K(n))}{if(!(e instanceof iN||e instanceof iA))throw new S(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let n=e._path.child(B.fromString(t,...r));return iw(n),new iN(e.firestore,e instanceof iA?e.converter:null,new K(n))}}(e),a=(r=e.converter)?r.toFirestore(t):t;return(n=[(function(e,t,r,n,i,s={}){let a,o;let l=e.Nu(s.merge||s.mergeFields?2:0,t,r,i);iQ("Data must be an object, but it was:",l,n);let u=function e(t,r){let n={};return et(t)?r.path&&r.path.length>0&&r.fieldMask.push(r.path):ee(t,(t,i)=>{let s=function t(r,n){if(iK(r=(0,h.m9)(r)))return iQ("Unsupported field value:",n,r),e(r,n);if(r instanceof iO)return function(e,t){if(!iB(t.wu))throw t.Mu(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.Mu(`${e._methodName}() is not currently supported inside arrays`);let r=e._toFieldTransform(t);r&&t.fieldTransforms.push(r)}(r,n),null;if(void 0===r&&n.ignoreUndefinedProperties)return null;if(n.path&&n.fieldMask.push(n.path),r instanceof Array){if(n.settings.Du&&4!==n.wu)throw n.Mu("Nested arrays are not supported");return function(e,r){let n=[],i=0;for(let s of e){let e=t(s,r.Fu(i));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),i++}return{arrayValue:{values:n}}}(r,n)}return function(e,t){var r,n,i;if(null===(e=(0,h.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return r=t.serializer,"number"==typeof(i=n=e)&&Number.isInteger(i)&&!J(i)&&i<=Number.MAX_SAFE_INTEGER&&i>=Number.MIN_SAFE_INTEGER?tp(n):tg(r,n);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let r=P.fromDate(e);return{timestampValue:rt(t.serializer,r)}}if(e instanceof P){let r=new P(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:rt(t.serializer,r)}}if(e instanceof iF)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof iV)return{bytesValue:rr(t.serializer,e._byteString)};if(e instanceof iN){let r=t.databaseId,n=e.firestore._databaseId;if(!n.isEqual(r))throw t.Mu(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:ri(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof iP)return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:e.toArray().map(e=>{if("number"!=typeof e)throw t.Mu("VectorValues must only contain numeric values.");return tg(t.serializer,e)})}}}}};throw t.Mu(`Unsupported field value: ${iE(e)}`)}(r,n)}(i,r.bu(t));null!=s&&(n[t]=s)}),{mapValue:{fields:n}}}(n,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=function(e,t,r){if((t=(0,h.m9)(t))instanceof iM)return t._internalPath;if("string"==typeof t)return ij(e,t);throw iW("Field path arguments must be of type string or ",e,!1,void 0,r)}(t,n,r);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iq(new eM(u),a,o)})(function(e){let t=e._freezeSettings(),r=r4(e._databaseId);return new i$(e._databaseId,!!t.ignoreUndefinedProperties,r)}(e.firestore),"addDoc",s._key,a,null!==e.converter,{}).toMutation(s._key,tk.exists(!1))],function(e,t){let r=new N;return e.asyncQueue.enqueueAndForget(async()=>nZ(await im(e).then(e=>e.syncEngine),t,r)),r.promise}(ix(i),n)).then(()=>s)}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:r,options:n})=>{let i=t.getProvider("app").getImmediate(),s=new iD(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,r),i);return n=Object.assign({useFetchStreams:e},n),s._setSettings(n),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.2",void 0),(0,o.KN)(m,"4.7.2","esm2017")}()}}]);